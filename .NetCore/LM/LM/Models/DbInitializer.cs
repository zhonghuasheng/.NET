...
namespace LM.Models
{
    ...
    {
        public static void SeedNoodles(AppDbContext context)
        {
        ...
        public static void SeedFeedBacks(AppDbContext context)
        {
            ...
            context.AddRange(
                new FeedBack { Name = "Alex", Email = "1@qq.com", Message = "好吃", CreateDateUTC = DateTime.UtcNow },
                new FeedBack { Name = "Cassie", Email = "2@qq.com", Message = "好吃", CreateDateUTC = DateTime.UtcNow },
                new FeedBack { Name = "Luke", Email = "3@qq.com", Message = "好吃", CreateDateUTC = DateTime.UtcNow }
                );
