...
{
    [TestClass]
    public class IrregularSymbolCalculationOutputUT
    {
        ...
        public void TestWriteOutput()
        {
            ...
            OutputBase output = new IrregularSymbolCalculationOutput(context);
            Assert.AreEqual(output.WriteOutput(context.Questions[0]), false);

            Assert.AreEqual(output.WriteOutput(context.Questions[1]), true);
        }
